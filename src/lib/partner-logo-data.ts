...
export const partnerLogos: PartnerLogo[] = [
  ...
  { slug: "university-of-leeds", name: "University of Leeds", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "university-of-leeds.webp" },
  ...
  { slug: "royal-holloway-university-of-london", name: "Royal Holloway, University of London", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "royal-holloway-university-of-london.webp" },
  { slug: "university-of-huddersfield", name: "University of Huddersfield", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "university-of-huddersfield.webp" },
  ...
  { slug: "liverpool-john-moores-university", name: "Liverpool John Moores University", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "liverpool-john-moores-university.webp" },
  { slug: "university-of-aberdeen", name: "University of Aberdeen", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "university-of-aberdeen.webp" },
  { slug: "university-of-surrey", name: "University of Surrey", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "university-of-surrey.webp" },
  { slug: "university-of-sussex", name: "University of Sussex", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "university-of-sussex.webp" },
  { slug: "university-of-strathclyde", name: "University of Strathclyde", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "university-of-strathclyde.webp" },
  { slug: "university-of-dundee", name: "University of Dundee", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "university-of-dundee.webp" },
  ...
  { slug: "bournemouth-university", name: "Bournemouth University", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "bournemouth-university.webp" },
  { slug: "london-metropolitan-university", name: "London Metropolitan University", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "london-metropolitan-university.webp" },
  { slug: "sruc-scotlands-rural-college", name: "SRUC (Scotland's Rural College)", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "sruc-scotlands-rural-college.webp" },
  ...
  { slug: "brunel-university-london", name: "Brunel University London", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "brunel-university-london.webp" },
  ...
  { slug: "university-of-kent", name: "University of Kent", country: "United Kingdom", countrySlug: "study-in-uk", flag: "gb", logo: "university-of-kent.webp" },
  ...
  { slug: "boston-university", name: "Boston University", country: "United States", countrySlug: "study-in-usa", flag: "us", logo: "boston-university.webp" },
  { slug: "arizona-state-university", name: "Arizona State University", country: "United States", countrySlug: "study-in-usa", flag: "us", logo: "arizona-state-university.webp" },
  ...
  { slug: "cleveland-state-university", name: "Cleveland State University", country: "United States", countrySlug: "study-in-usa", flag: "us", logo: "cleveland-state-university.webp" },
  ...
  { slug: "university-of-central-florida", name: "University of Central Florida", country: "United States", countrySlug: "study-in-usa", flag: "us", logo: "university-of-central-florida.webp" },
  { slug: "university-of-illinois-chicago", name: "University of Illinois Chicago", country: "United States", countrySlug: "study-in-usa", flag: "us", logo: "university-of-illinois-chicago.webp" },
  { slug: "university-of-illinois-springfield", name: "University of Illinois Springfield", country: "United States", countrySlug: "study-in-usa", flag: "us", logo: "university-of-illinois-springfield.webp" },
  ...
  // Australia
  { slug: "james-cook-university-australia", name: "James Cook University Australia", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "james-cook-university-australia.webp" },
  { slug: "curtin-university", name: "Curtin University", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "curtin-university.webp" },
  { slug: "southern-cross-university", name: "Southern Cross University", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "southern-cross-university.webp" },
  ...
  { slug: "canberra-college", name: "Canberra College", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "canberra-college.webp" },
  { slug: "western-sydney-university", name: "Western Sydney University", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "western-sydney-university.webp" },
  ...
  { slug: "sae-university-college", name: "SAE University College", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "sae-university-college.webp", darkLogo: true },
  ...
  { slug: "university-of-canberra-college", name: "University of Canberra College", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "university-of-canberra-college.webp" },
  ...
  { slug: "tastafe", name: "TasTAFE", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "tastafe.webp", darkLogo: true },
  ...
  { slug: "canberra-business-and-technology-college", name: "Canberra Business and Technology College", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "canberra-business-and-technology-college.webp" },
  { slug: "australian-institute-of-business-intelligence", name: "Australian Institute of Business Intelligence", country: "Australia", countrySlug: "study-in-australia", flag: "au", logo: "australian-institute-of-business-intelligence.webp", darkLogo: true },
  ...
  { slug: "iu-internationale-hochschule", name: "IU International University of Applied Sciences", country: "Germany", countrySlug: "study-in-germany", flag: "de", logo: "iu-internationale-hochschule.webp" },
  { slug: "lancaster-university-leipzig", name: "Lancaster University Leipzig", country: "Germany", countrySlug: "study-in-germany", flag: "de", logo: "lancaster-university-leipzig.webp" },
  ...
  { slug: "university-of-europe-for-applied-sciences", name: "University of Europe for Applied Sciences", country: "Germany", countrySlug: "study-in-germany", flag: "de", logo: "university-of-europe-for-applied-sciences.webp" },

  // Ireland
  { slug: "griffith-college", name: "Griffith College", country: "Ireland", countrySlug: "study-in-ireland", flag: "ie", logo: "griffith-college.webp" },

  // Global
  { slug: "spj-global", name: "SP Jain School of Global Management", country: "Global", countrySlug: "", flag: "", logo: "spj-global.webp" },
];
