    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-5 pb-20 lg:px-8">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { title: "Helpline", value: contact.phoneDisplay, href: contact.phoneHref, track: "phone_click" },
            { title: "Email Us", value: contact.email, href: `mailto:${contact.email}` },
            { title: "WhatsApp", value: "Quick chat with our team", href: contact.whatsappHref, external: true, track: "whatsapp_click" },
            { title: "Office Hours", value: contact.hours },
          ].map((c, i) => (
